### <div align="center">Меня зовут Данила, я .NET Backend и Desktop разработчик👨‍💻 </div>  
  

- 📝 В данный момент изучаю PHP и продолжаю изучать платформу .NET
  

- ⚡ Занимаюсь программированием с 2019 года  
  

Мой путь в программирование начался с небольшого интереса в школе к разработке компьютерных игр на движке Unity с использованием языка программирования C#. После чего у меня появилось желание и рвение продолжать работать в сфере программирования, и я поступил в колледж на программиста. Параллельно учебе я проходил бесплатные курсы в свободном доступе в интернете и начал делать свои проекты, которые можно увидеть здесь в моем профиле =)   
